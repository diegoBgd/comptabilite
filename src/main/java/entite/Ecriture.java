...
import javax.persistence.Transient;
   ...
   implements Serializable
 {
   ...
   @Column(name = "type_operation",columnDefinition = "default 0")
   private int typeOperation;
   @Column(name = "source_operation",columnDefinition = "default 0")
   private int sourceOperation;
   @Column(name = "debit",columnDefinition = "default 0")
