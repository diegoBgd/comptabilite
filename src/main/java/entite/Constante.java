   ...
   implements Serializable
 {
   ...
   {
     GestionAcces, ParametreGeneraux, ParametreEfi, Journal, PlanComptable, SaisieEcritures,
     EditionEfi, EditionHistoriques, SaisieImmo, Amortissement, Cession, ParametrageFinance,
     EntreeFond, ReglementClient, FactureFourn, ReglementFournisseur, AutresDepenses;
   }
