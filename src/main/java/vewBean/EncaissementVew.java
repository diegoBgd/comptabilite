   ...
   implements Serializable
 {
   ...
   SessionFactory factory = DBConfiguration.getSessionFactory(); private TypeRecette selectedRecette; private String codeClt; private String libelleClt; private String printDate; private String rechLblRec; private String infoMsg; private String printTot; private String codeRec; private String libelleRec; private String rechLblClt; private String rechDateDeb; private String rechDateFin; private String comment; private String pieceOper; private String numEnc; private double totalRegle; private double montantFacture; private double tauxTva; private double tauxDevise; private double montantHt; private double montantTvac; EncaissementModel model;
   ...
   public void setListeClient(List<Clients> listeClient) {
   ...
   public void chargerClient() {
     this.listeClient = (new ClientModel()).getListClients(this.factory, this.rechLblClt);
   }
   
   public void searchClient() {
     if (this.codeClt != null && !this.codeClt.equals("")) {
       
       this.selectedClient = (new ClientModel()).getClientByCode(this.factory, this.codeClt);
       clientValues();
     } 
   }
   ...
   private void clientValues() {
     if (this.selectedClient != null) {
       ...
       this.codeClt = this.selectedClient.getCodeClt();
       this.libelleClt = this.selectedClient.getNameClt();
     } 
   }
   ...
   public void calculerMontantHT() {
     ...
     if (this.printDate.replace("/", "").replace("_", "").trim().equals("")) {
       ...
       if (this.dateOp == null) {
         ...
         if (!HelperC.periodeValide(this.dateOp, this.selectdExercice.getDateDebut(), this.selectdExercice.getDateFin()))
         {
   ...
   public void chargerEncaissement() {
     this.listEncaissement = this.model.getListEncaissement(this.factory, this.selectdExercice.getId(), getDateDebut(), getDateFin(), this.typeOper);
   }
   ...
   private void getEncaissementValue() {
     if (this.selectedEncaissement != null) {
       ...
       this.selectedClient = this.selectedEncaissement.getClient();
   ...
   public void save() {
     if (this.dateOp != null) {
       ...
       this.selectedEncaissement.setClient(this.selectedClient);
