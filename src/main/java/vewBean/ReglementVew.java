   ...
   implements Serializable
 {
   ...
   SessionFactory factory = DBConfiguration.getSessionFactory(); private String rechDateDeb; private String rechDateFin; private String infoMsg; private String numeroDepense; private String pieceRegl; private String codeChrg; private String libelleChrg; private String rechCharge; private Date dateDebut; private Date dateFin; private Date dateOperation; private boolean disableMsg; private boolean disableSave; private List<Fournisseur> listFournisseur; private List<Depense> listDepense; private double montantDepense; private double totalRegle; private double courDevse; private double tauxTaxe; private double montantHt; private double montantTTC; ReglementModel model;
   ...
   public void changeDate() {
     ...
     if (this.printDate.replace("/", "").replace("_", "").trim().equals("")) {
       ...
       if (this.dateOperation == null) {
         ...
         if (!HelperC.periodeValide(this.dateOperation, this.selecetdExercice.getDateDebut(), this.selecetdExercice.getDateFin())) {
   ...
   public void chargerDepense() {
     this.listDepense = (new DepenseModel()).getListDepense(this.factory, this.selecetdExercice.getId(), null, this.dateDebut, this.dateFin);
   }
   ...
   public void chargerReglement() {
     this.listReglement = this.model.getListReglement(this.factory, this.typeOper, this.selectedDepense, this.selecetdExercice.getId(), this.dateDebut, this.dateFin);
   }
   ...
   public void save() {
     if (this.dateOperation != null)
     {
       if (testMontant()) {
         ...
         HelperC.afficherAttention("Attention", "La montant à régler ne peut pas dépasser total de la facture!");
       }  } 
   }
