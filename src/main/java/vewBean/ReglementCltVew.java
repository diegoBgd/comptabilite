   ...
   implements Serializable
 {
   ...
   int idReg = 0; private String infoMsg; private String printTot; private String codeRec; private String libelleRec; private String rechLblClt; private String rechDateDeb; private String rechDateFin; private String comment; private String pieceOper;
   ...
   private double montantHt; private double montantTvac; ReglementClientModel model; Exercice selectdExercice; HttpSession session; String exerCode; String currUserCode; User currentUser; Devise selectedDev; Taxes selectedTaxe; CentreCout selectedCentre; BankAccount selectedCpt; Banque selectedCaisse; TypeEcriture typeOper;
   ...
   public void chargerFactureClient() {
     this.listEncaissement = (new EncaissementModel()).getListEncaissement(this.factory, this.selectdExercice.getId(), getDateDebut(), getDateFin(), TypeEcriture.factureClient);
   }
   ...
   public void chargerReglement() {
     if (this.selectedEncaissement != null) {
       this.listReglement = this.model.getListReglement(this.factory, this.selectdExercice.getId(), this.dateDebut, this.dateFin, this.selectedEncaissement);
     } else {
