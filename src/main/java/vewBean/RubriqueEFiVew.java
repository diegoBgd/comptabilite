...
public class RubriqueEFiVew implements Serializable {
	...
	public void addDetail() {
		...
		if (!this.selected) {
			this.selectedDetail.setLigne(this.listDetail.size());

			this.listDetail.add(this.selectedDetail);
		} else {
			this.listDetail.remove(this.selectedDetail);
			this.selectedDetail.setLigne(this.index);
	...
	public void save() {
		if (this.selectedEfi != null) {
			...
			HelperC.afficherAttention("Attention", "Il faut préciser l'état financier !");
		}
