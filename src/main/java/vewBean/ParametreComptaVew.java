...
@ManagedBean
@ViewScoped
public class ParametreComptaVew implements Serializable {
	...
	private String jrnOD;
	private String libelleJrnOd;
	...
	public void save() {
		...
		try {
			...
			chargerParametre();
			HelperC.afficherMessage("Succès", "Enregistrement effectué");
		} catch (Exception e) {
			HelperC.afficherErreur("Erreur", "Erreur d'enregistrement");
		}
